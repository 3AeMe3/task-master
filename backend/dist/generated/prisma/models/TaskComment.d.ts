...
export type TaskCommentWhereInput = {
    ...
    authorId?: Prisma.IntFilter<"TaskComment"> | number;
...
export type TaskCommentScalarWhereWithAggregatesInput = {
    ...
    authorId?: Prisma.IntWithAggregatesFilter<"TaskComment"> | number;
};
...
export type TaskCommentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "content" | "createdAt" | "taskId" | "authorId", ExtArgs["result"]["taskComment"]>;
...
export interface TaskCommentFieldRefs {
    ...
    readonly authorId: Prisma.FieldRef<"TaskComment", 'Int'>;
}
/**
