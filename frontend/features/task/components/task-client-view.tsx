    ...
    <>
      ...
      >
        <SheetContent className="gap-0 overflow-scroll scroll-smooth">
          ...
          <div className="h-full border bg-[#fafbfc] px-4 pt-5">
            ...
            <div className="grid grid-cols-2 gap-y-5 border-b border-gray-300 py-5">
              <div className="flex flex-col justify-center">
                <Badge variant={'ghost'} className="px-0 text-gray-500">
